...
public sealed class Settings
{
    ...
    public string Language { get; set; } = "en";     // code of assets/lang/<code>.txt
    // Phase 1 display options
    public bool Fullscreen { get; set; } = false;
    public int WindowW { get; set; } = 1280;
    public int WindowH { get; set; } = 800;
    public bool VSync { get; set; } = true;          // GDI+: 60fps cap
    public int FpsLimit { get; set; } = 0;           // 0 = unlimited (when VSync off)
    public bool PauseOnFocusLoss { get; set; } = true;
    public bool ShowFps { get; set; } = false;
    public string Panels { get; set; } = "";      // dragged HUD panel positions
...
public sealed class BuildingDto
{
    ...
    public float Dig { get; set; }                // RECLAMATION: ark excavation
    public float Wear { get; set; }               // ORGANISM: machine wear
...
public sealed class ColonistDto
{
    ...
    public int Stance { get; set; } = 1;          // Fight=0 Flee=1 Ignore=2
    ...
    public int[]? OpCids { get; set; }
    public float[]? OpVals { get; set; }
}

public sealed class BlueprintDto
{
    public int Kind { get; set; }
    public int X { get; set; }
    public int Y { get; set; }
...
public sealed class MineDto
{
    public int X { get; set; }
    public int Y { get; set; }
    public int Cycles { get; set; } = int.MaxValue;
}
...
public sealed class RaiderDto
{
    ...
    public bool Sapper { get; set; }            // MADDOG iter-8
}

// MADDOG iter-4: wildlife
public sealed class BeastDto
{
    public float X { get; set; }
    public float Y { get; set; }
    public float Hp { get; set; }
...
public sealed class CarcassDto
{
    public float X { get; set; }
    public float Y { get; set; }
...
public sealed class GameSave
{
    ...
    public int BiomeSave { get; set; }            // NEW WORLDS
    ...
    public List<BeastDto> Beasts { get; set; } = new();       // MADDOG iter-4
    public List<CarcassDto> Carcasses { get; set; } = new();  // MADDOG iter-4
    ...
    public int Weather { get; set; }            // MADDOG iter-3 (WeatherKind)
    public float WeatherT { get; set; }
    public int HintsDone { get; set; }          // MADDOG iter-5 onboarding
    public List<string>? Chronicle { get; set; }  // SOULS: "day|text" lines
    public int Chapter { get; set; }              // RECLAMATION
    public float FinaleAt { get; set; } = -1;
    public bool FinalePending { get; set; }
    public bool FinaleCleared { get; set; }
    public bool Hope { get; set; }
    public int EndingChosen { get; set; }
    public List<string>? Blight { get; set; }     // "chunkKey:level"
    public bool TraderHere { get; set; }        // MADDOG iter-9 caravan
    public float TraderX { get; set; }
    public float TraderY { get; set; }
    public bool TraderArrived { get; set; }
    public float TraderWindow { get; set; }
    public List<int>? TraderSold { get; set; }
    public int StatKills { get; set; }          // MADDOG iter-7 statistics
    public int StatBeastsHunted { get; set; }
    public int StatBuilt { get; set; }
    public int StatMined { get; set; }
    public int StatMeals { get; set; }
    public List<float>? WealthHist { get; set; }
